-- CreateTable (idempotent: table may already exist from legacy migration name)
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "membership_freeze_requests_membership_id_idx" ON "public"."membership_freeze_requests"("membership_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "membership_freeze_requests_status_idx" ON "public"."membership_freeze_requests"("status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "membership_freeze_requests_freeze_end_date_idx" ON "public"."membership_freeze_requests"("freeze_end_date");
